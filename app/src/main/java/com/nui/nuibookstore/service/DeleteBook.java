...
//        bookDao.delete(new Book("son test again","son","son","novel",12.4,R.drawable.the_transcriptionist));
    ...
    protected void onPostExecute(Void success){
        System.err.println("Delete test done");
    }
    ...
    private List<Book> getAllBookToDelete(){
        ...
        bookList.add(new Book("son test again","son","son","novel",12.4,R.drawable.the_transcriptionist));
